    ...
    <>
      <div className="w-[20%] h-full border-r-2 border-zinc-400 p-8">
        ...
        <nav className="flex flex-col text-zinc-400 text-xl gap-1">
          ...
          <Link target="_blank" to={`https://github.com/sagaragrawal9/Movie_Time`} className="hover:bg-white hover:text-black duration-300 rounded-xl p-4"><i className="mr-2 ri-code-s-slash-line"></i>Codebase</Link>
        </nav>
      </div>
    </>
  );
